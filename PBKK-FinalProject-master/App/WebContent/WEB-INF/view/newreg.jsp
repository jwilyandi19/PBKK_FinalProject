          ...
          <p>Registrasi User Baru</p>
        	<form:form method="POST" action="addUser" modelAttribute="user">
					...
					<div class="form-group">
						...
						<form:input class="form-control" path="userNama" required="required"/>          								
					</div>
					<div class="form-group">
          				<form:label path="userEmail">Email</form:label>
          				<form:input type="email" class="form-control" path="userEmail" required="required"/>          								
					</div>
					<div class="form-group">
						<form:label path="userHp">No. HP</form:label>  
						<form:input class="form-control"  path="userHp" required="required"/>
          				        								
					</div>
					<div class="form-group">
						<form:label path="userPassword">Password</form:label> 
						<form:input  class="form-control" type="password" path="userPassword" required="required"/>
