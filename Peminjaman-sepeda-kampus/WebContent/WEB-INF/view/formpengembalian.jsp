      ...
      <div class="modal-content" style="border: 2px solid">
        ...
        <div class="row" >
          ...
          <div class="col-8 " style="margin-top: 20px">
            ...
            <h4><strong>FORM PENGEMBALIAN SEPEDA</strong></h4>
          ...
          <form action="homepage" method="post">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" rowspan = 2></textarea> 
            </div>
            


            <button type="submit" class="btn btn-primary" style="margin-bottom: 20px">SELESAI</button>
          </form>
